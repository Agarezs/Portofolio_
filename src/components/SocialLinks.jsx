...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/Garminn/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@itsgaarr",
    icon: Instagram,
    url: "https://www.instagram.com/itsgaarr/?hl=id",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@Enggar",
    icon: Youtube,
    url: "https://www.youtube.com/@garminnn",
    color: "#FF0000",
